...
import {register,verifyOTP,resendOTP,login,updateProfile,forgotPassword,
resetPassword
...
routes.put( '/profile', auth, upload.single('profileimage'), validate(updateProfileSchema), updateProfile);
